/*   STEP 1   */
export const leagueID = "821947280339898368"; // your league ID
export const leagueName = "Knockoff Football League"; // your league name
...
export const homepageText = `
  <p>Welcome to the Knockoff Football League Website!</p>
`;
